...
if (isset($_POST['submit'])) {
    ...
    if ($_FILES['song']) {
        ...
        move_uploaded_file($song_tmp, "../videos/".$song_name);
    }
    ...
    $sql = "INSERT INTO songs (song_title, song_img, song_path, type, date_added, author, song_category_id_FK, adder_admin) VALUES ('$title', '$img_name', '$song_name', 'video', '$current_date', '$author_name', '$cat_id', '$adder_admin')";
