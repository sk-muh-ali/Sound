          ...
          <div class="card-body">
            ...
            <div class="table-responsive" style="overflow-x: hidden;">
              <table class="table table-hover">
                ...
                <tbody>
                  <?php
                  $sql_users_show = "SELECT * FROM users where user_role='user';";
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="./user_ban.php?id=<?php echo $row["id"];?>" type="submit" class="btn btn-light px-3"><i class="fa-solid fa-ban"></i></a>
                      </td>
                    </tr>
                  <?php
                        $serial_number++;
