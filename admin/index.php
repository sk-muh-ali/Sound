<?php
    ...
    $sql_request_show = "SELECT * FROM user_requests;";
    $result_request_show = mysqli_query($conn, $sql_request_show);
?>
                ...
                <div class="row row-group m-0">
                    ...
                    <div class="col-lg-6 col-xl-6 border-light p-4">
                        <div class="card-body">
                            ...
                            <h1 class="text-white text-center" style="font-size: 5rem;"><?php echo mysqli_num_rows($result_request_show);?></h1>
                        </div>
                    </div>
                </div>
            </div>
