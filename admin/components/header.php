    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
            ...
            <ul class="sidebar-menu do-nicescrol">
                <li class="sidebar-header enable-shadows">MAIN NAVIGATION</li>
                <li>
                    <a href="./index.php">
                ...
                <li>
                    ...
                    <i class="fa-solid fa-photo-film"></i> <span>Videos</span>
                    </a>
                </li>

                <li>
                    <a href="./users_show.php">
                    <i class="fa-solid fa-user-slash"></i> <span>Users</span>
                    </a>
                </li>
